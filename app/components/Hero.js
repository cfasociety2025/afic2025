...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen lg:min-h-[70vh] xl:min-h-[70vh] bg-cfa-dark-blue overflow-hidden" role="banner">
      {/* YouTube Background Video */}
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-cfa-dark-blue">
        <iframe
