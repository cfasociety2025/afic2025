...
export default function TravelHero() {
  return (
    <section className="relative bg-[#06005A] py-16 sm:py-20 lg:py-24 overflow-hidden" role="region" aria-label="Travel and Venue Information">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="max-w-xl">
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-10">
                <p className="body-copy text-base sm:text-lg leading-relaxed text-gray-200">
                  Join us in Nairobi, Kenya's vibrant capital city, for AfIC 2025. Discover essential travel information, visa requirements, and explore the beauty of Kenya.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="w-full max-w-2xl mx-auto">
              <Image
                src="/afic15.png"
                alt="Nairobi, Kenya - Host City for AfIC 2025"
                width={700}
                height={525}
