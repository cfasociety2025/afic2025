...
export default function SponsorshipHero() {
  return (
    <section className="relative bg-gradient-to-l from-blue-600 via-blue-800 to-blue-900/90 py-16 sm:py-20 lg:py-24 overflow-hidden" role="region" aria-label="Sponsorship Opportunities">
            ...
            <div className="max-w-xl">
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-10">
                <p className="body-copy text-base sm:text-lg leading-relaxed text-gray-200">
                  Partner with Africa's premier investment conference. Position your brand alongside 500+ finance leaders, investors, and innovators shaping the continent's economic future.
                </p>
              </div>
            </div>
          </div>
