...
export default function AgendaHero() {
  return (
    <section className="relative bg-gradient-to-l from-blue-600 via-blue-800 to-blue-900/90 py-16 sm:py-20 lg:py-24 overflow-hidden" role="region" aria-label="Conference Agenda Overview">
