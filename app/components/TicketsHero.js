...
export default function TicketsHero() {
  return (
    <section className="relative bg-[#08024a] py-16 sm:py-20 lg:py-24 overflow-hidden" role="region" aria-label="Secure Your Place at AfIC 2025">
      {/* Background overlay for depth */}
      <div className="absolute inset-0 bg-[#08024a] to-blue-900/60" aria-hidden="true"></div>
