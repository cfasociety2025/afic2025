...
export const speakersData = [
  {
    ...
    bio: "Francis is the founder and CEO of Raisin Capital, an African capital-raising house dedicated to helping businesses access growth capital. He is also the co-founder of Capital Connect, a digital platform connecting SMEs and startups with investors, financing options, and advisory support at scale. A CFA Charter holder and CPA, Francis brings over 18 years of experience in corporate finance, advisory, and private equity, having led complex mandates across sectors including agribusiness, financial services, healthcare, education, and technology. An Electrical Engineer by training, Francis serves as President of the CFA Society East Africa, where he champions initiatives to develop capital markets and mentor the next generation of finance leaders across Africa.",
    expertise: [],
    achievements: [
    ],
    social: {
      linkedin: "https://www.linkedin.com/in/francis-nasyomba-cfa/"
    },
    featured: true
  },
  {
    ...
    image: "https://afic2025.s3.us-east-1.amazonaws.com/3.png", // Will use initials placeholder
    ...
    social: {
      linkedin: "https://www.linkedin.com/in/razaqa/",
      twitter: "https://x.com/razaqahmed1"
    },
  ...
  },
  {
    ...
    image: "https://afic2025.s3.us-east-1.amazonaws.com/2.png", // Will use initials placeholder
    ...
    social: {
      linkedin: "https://www.linkedin.com/in/jojo-bannerman-cfa-857a3428/",
      twitter: "https://x.com/Jojo_Bannerman"
    },
    featured: true // Show on homepage
  },

  {
    ...
    image: "https://afic2025.s3.us-east-1.amazonaws.com/4.png",
  ...
  {
    id: 5,
    name: "Chandradev (Sunju) Naregadu",
    title: "President",
    company: "CFA Society Mauritius",
    image: "https://afic2025.s3.us-east-1.amazonaws.com/1.png",
    bio: "Chandradev (Sunju) Naregadu is the President of the CFA Society Mauritius since Sep 2024, having previously served on the Board as Advocacy Chair.  A Chartered Financial Analyst (CFA) charterholder since 2017, Sunju holds a BSc (Hons) in Economics and Finance from the University of Mauritius and is ACCA qualified. With extensive experience in risk, investment and strategy management, Sunju currently serves as the Asset-Liability & Capital Management (ALCM) Lead at the Mauritius Commercial Bank (MCB). In this capacity, he focuses on balance-sheet and capital management, with an emphasis on the formulation and implementation of pricing, optimization and profitability strategies for entities within the Group. Previously, he has led various teams in the management of financial and operational risks at the leading banking and non-banking financial institutions in Mauritius, namely MCB, SBM and CIM Finance. He started his career as auditor at Ernst & Young, Mauritius.",
    expertise: [],
    achievements: [
    ],
    social: {
      linkedin: " https://www.linkedin.com/in/sunju-naregadu/",
      twitter: ""
    },
    featured: true
  },
  {
    id: 6,
    name: "Ashraf El Khatib, CFA, MBA",
    title: "Vice President",
    company: "CFA Society Egypt",
    image: "https://afic2025.s3.us-east-1.amazonaws.com/ashraf.png",
    bio: "Ashraf El Khatib is Vice President of CFA Society Egypt and a long-standing global volunteer with CFA Institute. He serves as Vice Chair of the CFA Institute Education Advisory Committee, a 14-member global body that oversees the Institute’s education process. He also contributes to curriculum development in private markets and sustainable investing and frequently speaks at international investment conferences. Under his leadership, CFA Society Egypt received the CFA Institute Global Most Innovative Initiative Award in 2011, and Ashraf was honored with the Best EMEA Talk Award at the 2017 CFA Institute EMEA Society Leadership Conference. Ashraf is the Chief Investment Officer, Private Equity, at Ekuity Holding—the investment arm of the Kuwait Investment Authority (KIA) in Egypt—where he manages direct and indirect investment strategies. Previously, at NI Capital, he led the creation of a leading microfinance institution that achieved a successful exit to EBRD, BII, and other global private equity firms. Earlier in his career with PwC, he advised on M&A transactions across the Middle East and Africa. Beyond his professional role, Ashraf has held leadership positions in innovation initiatives with IE Business School, PwC, CFA Institute, and the World Bank. He holds an MBA from IE Business School and is a CFA Charterholder. In addition, he has passed the CPA exams and earned both the CFA Institute ESG Investing and Climate Investing Certificates. He is fluent in Arabic and English, with working knowledge of Spanish.",
    expertise: [],
    achievements: [
    ],
    social: {
      linkedin: "https://www.linkedin.com/in/ashrafelkhatib/",
      twitter: ""
    },
    featured: true
  },
