...
export const speakersData = [
  {
    ...
    bio: "Francis Nasyomba is a CFA charterholder with extensive experience in emerging markets. He has successfully managed over $1.5B in assets and specializes in African equity markets and alternative investments.",
    expertise: [],
    achievements: [
    ],
    social: {
